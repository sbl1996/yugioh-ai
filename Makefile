...
vendor/ygopro-core:
	cd vendor && wget https://github.com/Fluorohydride/ygopro-core/archive/master.zip
	unzip -q vendor/master.zip -d vendor; mv vendor/ygopro-core-master $@
...
vendor/ygopro-scripts:
	cd vendor && wget https://github.com/Fluorohydride/ygopro-scripts/archive/master.zip
	unzip -q vendor/master.zip -d vendor; mv vendor/ygopro-scripts-master $@
